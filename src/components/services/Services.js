        ...
        <section className={classes.section} style={{backgroundImage:`url(${dotImage})`, backgroundRepeat:"repeat"}}>
          ...
          <h2 className={classes.textInt}> Our experience and commitment are focused on... </h2>
            ...
            <div className="container">
                <div className="row" >
                    <div className="col-md"  style={{ backgroundColor:"#c3ced4"}}>
                      ...
                      <div style={{textAlign:"center", margin:"0.2em"}}>
                        <img  src={image1} className={classes.images} alt="Response" />
                      </div>

                    </div>
                    <div className="col-md" style={{ backgroundColor:"#a0bcbf" }}>
                      ...
                      <div style={{textAlign:"center", margin:"0.2em"}}>
                        <img  src={image2} className={classes.images} alt="training"/>
                      </div>
                    ...
                    <div className="col-md" style={{ backgroundColor:"#c3ced4"}} >
                       ...
                       <div style={{textAlign:"center", margin:"0.2em"}}>
                         <img  src={image3} className={classes.images} alt="Consulting"/>
                       </div>
                    </div>
                </div>
            </div>
